...
def welcome():
    ...
    with response.gather(
        ...
        _message = "Thanks for calling the E T Phone Home Service. "
        _message += "Please press 1 for directions. "
        _message += "Press 2 for a list of planets to call."

        g.say(message=_message, loop=3)
...
def _give_instructions(response):  # noqa: W504
